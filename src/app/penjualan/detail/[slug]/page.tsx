...
export default function DetailPenjualanPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      const response = await axios.get(`${CUSTOM_TEXT.api_penjualan}/${slug}`, {
        validateStatus: () => true,
      });
  ...
  return (
    <div className="area-content">
      <CustomBreadcrumb />
      <CustomCard
        title={`${CUSTOM_TEXT.text_detail_data} ${CUSTOM_TEXT.menu_penjualan}`}>
        <CustomLoading isLoading={isLoading}>
          <div className="area-form-content">
            ...
            <div>
              ...
              <CustomInput
                value={
                  barang?.harga != null
                    ? formatNumber(Number(barang.harga))
                    : ""
                }
                readOnly
                className="input-text"
            ...
            <div>
              ...
              <CustomInput
                ...
                className={
                  error.jumlah && !isEdit ? "input-error" : "input-text"
                }
                maxLength={11}
          ...
          <div className="area-form-button">
            <CustomButton
              label={
                isEdit ? CUSTOM_TEXT.button_ubah : CUSTOM_TEXT.button_simpan
              }
